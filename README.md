...
// Use xcorr instead of corr to avoid "wrong number of output arguments"
error
r = xcorr(x, y);
plot2d3('gnn', r);
...
<img width="645" height="367" alt="image" src="https://github.com/user-attachments/assets/2759f99b-657b-4dfd-a8e9-4ecaf214a40b" />

_OUTPUT GRAPH:__

<img width="842" height="701" alt="image" src="https://github.com/user-attachments/assets/43844770-15ca-4b52-a457-cacae9b2738c" />

__RESULT:__

Thus, the program for mean and variance and cross relation in scilab has been done
